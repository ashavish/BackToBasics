...
First, is to identify them. Using the same mtcars dataset, lets first introduce some missing values.
...
We can see the three rows which have the missing values.
...
Lets flatten this matrix by writing a quick function
